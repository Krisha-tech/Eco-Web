...
<head>
    ...
    <link rel="stylesheet" href="fieldOff.css">
</head>
<body>
    <!DOCTYPE html>
<html lang="en">
...
<body>
    <div class="navbar">
        <div class="icon">
            <h2 class="logo">Field Officer Page</h2>
...
<div class="slideshow-container">
    ...
    <div class="mySlides fade">
      ...
      <img src="Images/field1.jpg" style="width:100%">
      <div class="text">Caption Text</div>
    </div>
  
    <div class="mySlides fade">
      <div class="numbertext">2 / 3</div>
      <img src="Images/field2.jpg" style="width:100%">
      <div class="text">Caption Two</div>
    </div>
  
    <div class="mySlides fade">
      <div class="numbertext">3 / 3</div>
      <img src="Images/field3.jpg" style="width:100%">
  ...
  <div class="sticky">  <h1>View And Replay As Admin</h1>
